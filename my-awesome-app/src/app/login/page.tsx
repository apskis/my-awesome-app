      ...
      <div className="max-w-md w-full bg-card border border-border rounded-2xl shadow-xl p-8">
        ...
        {loginMode === 'password' ? (
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-primary hover:bg-primary/90 disabled:opacity-50 text-primary-foreground font-medium py-3 px-4 rounded-lg transition-colors"
          >
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              disabled={isLoading}
              className="w-full inline-flex justify-center py-3 px-4 border border-border rounded-lg shadow-sm bg-card text-sm font-medium text-foreground hover:bg-accent disabled:opacity-50 transition-colors"
            >
